...
class TicketController extends Controller
{
    public function index()
    {
        ...
        $tickets = [
            ...
            (object)['id' => 'TK 002', 'title' => 'Broken Table Lamp', 'location' => 'M04 Saujana 04-34B',  'category' => 'Electrical & Lighting', 'date' => '23/02/2025', 'status' => 'Cancel'],
...
// }
    ...
    public function show($id)
    {
        $tickets = [
            ...
            (object)['id' => 'TK 002', 'title' => 'Broken Table Lamp', 'category' => 'Electrical & Lighting', 'description' => 'The study table lamp in my room is not functioning. The switch seems loose and the bulb does not turn on.', 'location' => 'M04 Saujana 04-34B',  'category' => 'Electrical & Lighting', 'date' => '23/02/2025', 'status' => 'Cancel', 'reason' => 'Not expert'],
